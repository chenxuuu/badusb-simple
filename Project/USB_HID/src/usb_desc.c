...
const uint8_t Joystick_DeviceDescriptor[JOYSTICK_SIZ_DEVICE_DESC] =
  {
    ...
    0x89,                       /*idVendor (0x1989)*/
    0x19,
    0x64,                       /*idProduct = 0x8964*/
    0x89,
...
const uint8_t Joystick_StringVendor[JOYSTICK_SIZ_STRING_VENDOR] =
  {
    ...
    'O', 0, 'S', 0, 'U', 0, 'k', 0, 'e', 0, 'y', 0, 'b', 0, 'o', 0,
    'a', 0, 'r', 0, 'd', 0, '.', 0, 'c', 0, 'h', 0, 'e', 0, 'n', 0,
    'x', 0, 'u', 0
  };
...
const uint8_t Joystick_StringProduct[JOYSTICK_SIZ_STRING_PRODUCT] =
  {
    ...
    USB_STRING_DESCRIPTOR_TYPE,        /* bDescriptorType */
    'O', 0, 'S', 0, 'U', 0, 'k', 0, 'e', 0, 'y', 0, 'b', 0,
    'r', 0, 'o', 0, 'a', 0, 'd', 0, '.', 0, ' ', 0, ' ', 0
  };
